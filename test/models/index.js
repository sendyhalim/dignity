...
var createTables = function () {
  ...
  tables.push(bookshelf.knex.schema.createTable('users', function (t) {
    t.increments();
    t.string('name');
  }));

  tables.push(bookshelf.knex.schema.createTable('roles', function (t) {
    t.increments();
    t.string('name');
  }));

  tables.push(bookshelf.knex.schema.createTable('permissions', function (t) {
    t.increments();
    t.string('name');
    t.string('display_name');
  }));

  tables.push(bookshelf.knex.schema.createTable('users_roles', function (t) {
    t.increments();
    t.integer('role_id').unsigned();
    t.integer('user_id').unsigned();
  }));

  tables.push(bookshelf.knex.schema.createTable('roles_permissions', function (t) {
    t.increments();
    t.integer('role_id').unsigned();
...
var insertModels = function () {
  ...
  models.push(bookshelf.knex.insert(dummyUser).into('users'));
  ...
  models.push(bookshelf.knex.insert(dummyRoles.ironman).into('roles'));
  models.push(bookshelf.knex.insert(dummyRoles.editor).into('roles'));
  ...
  models.push(bookshelf.knex.insert(dummyPermissions.playing).into('permissions'));
  models.push(bookshelf.knex.insert(dummyPermissions.googling).into('permissions'));
  models.push(bookshelf.knex.insert(dummyPermissions.watching).into('permissions'));
...
var insertRolesAndPermissions = function () {
  ...
  rolesAndPermissions.push(bookshelf.knex.insert([
